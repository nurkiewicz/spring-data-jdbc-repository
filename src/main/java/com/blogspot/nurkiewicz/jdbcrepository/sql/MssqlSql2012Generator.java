...
public class MssqlSql2012Generator extends AbstractMssqlSqlGenerator {
     ...
     */
    public final static String MSSQL_PAGINATION_CLAUSE = " OFFSET %s ROWS FETCH NEXT %s ROW ONLY";

    /**
     * Sort by first column
     */
    public final static String MSSQL_DEFAULT_SORT_CLAUSE = " ORDER BY 1 ASC";
